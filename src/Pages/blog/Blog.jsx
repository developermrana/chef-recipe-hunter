...
const Blog = () => {
  ...
  return (
    <div className="Container my-20">
      <Pdf targetRef={ref} filename="Question Answer.pdf">
        {({ toPdf }) => (
          <button
            className=" bg-lime-900 text-white px-5 py-2 rounded-md"
            onClick={toPdf}
          >
            Generate Pdf
          </button>
      ...
      <div ref={ref}>
        ...
        <div className="mb-7">
          ...
          <p>
            Ans: PropTypes is React internal mechanism for adding type checking
            ...
            component, they are checked against the type definitions configured
            in the propTypes property. When an invalid value is passed for a
            prop, a warning is displayed on the JavaScript console:
          </p>
        </div>
        <div className="mb-7">
          <h2 className="text-2xl">
        ...
        <div>
          ...
          <p>
            Ans: it can be reused easily, which makes the code cleaner and
